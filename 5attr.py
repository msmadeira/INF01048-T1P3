...
def compute_u(theta_0, theta_1, theta_2, theta_3, theta_4, theta_5, e1, e2, e3, e4, e5, yi):
    return (theta_0 + (e1 * theta_1) + (e2 * theta_2) + (e3 * theta_3) + (e4 * theta_4) + (e5 * theta_5)) - yi
...
def gradient_descent(data, starting_theta_0, starting_theta_1, starting_theta_2, starting_theta_3, starting_theta_4, starting_theta_5, learning_rate, num_iterations):
    ...
    for i in range(num_iterations):
        ...
        theta_2_progress.append(theta_3)
        theta_2_progress.append(theta_4)
        theta_2_progress.append(theta_5)
...
theta_0, theta_1, theta_2, theta_3, theta_4, theta_5, cost_graph, theta_0_progress, theta_1_progress, theta_2_progress, theta_3_progress, theta_4_progress, theta_5_progress = gradient_descent(
    house_prices_data,
    starting_theta_0=0,
    starting_theta_1=0,
    starting_theta_2=0,
...
print('Erro quadratico medio: ', compute_cost(theta_0, theta_1, theta_2, theta_3, theta_4, theta_5, house_prices_data))
